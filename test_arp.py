...
def test_ARP_packet_reply_packet():
  ...
  eth = ethernet.Ethernet_Frame(raw_frame)
  arp_packet = arp.ARP_packet(eth.data)
  assert arp_packet.conv_reply_packet()
  assert arp_packet.packet.hex() ==  '0001080006040002aabbccddeeff0a1401020011223344550a140101'

def test_ARP_packet_init_dummy():
  arp_packet = arp.ARP_packet()
  assert arp_packet.packet == b'\x00' * 28